  ...
  return (
    <main className="min-h-screen text-foreground">
      ...
      <div ref={pdfRef} className="meeting-pdf-template" aria-hidden="true">
        <div className="pdf-brand"><div><strong>Google Developer Groups<br />On Campus Xavier Ateneo</strong><small>Xavier University · Ateneo de Cagayan · Cagayan de Oro City</small></div></div>
