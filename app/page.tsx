      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 lg:grid-cols-[minmax(360px,0.82fr)_minmax(520px,1.18fr)] lg:px-8 lg:py-14">
        <section className="space-y-7">
          ...
          <div className="input-card">
            ...
            <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-xs text-muted-foreground"><label className="flex cursor-pointer items-center gap-2"><input type="checkbox" checked={applyMeetingFormat} onChange={(e) => setApplyMeetingFormat(e.target.checked)} className="h-3.5 w-3.5 accent-[var(--accent)]" /> Apply meeting format</label><label className="flex cursor-pointer items-center gap-2"><input type="checkbox" checked={clearAfterExport} onChange={(e) => setClearAfterExport(e.target.checked)} className="h-3.5 w-3.5 accent-[var(--accent)]" /> Clear output after export</label></div>
